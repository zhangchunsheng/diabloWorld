...
//        
//        CCLabelTTF * name111=CCLabelTTF::create("", "hycc.ttf", 20);
//        name111->setDimensions(CCSizeMake(200, 0));
//        name111->setHorizontalAlignment(kCCTextAlignmentCenter);
//        name111->setVerticalAlignment(kCCVerticalTextAlignmentTop);
//        name111->setPosition(ccp(tmpsz.width/2+1, 35));
//        
//        name111->setColor(colorbg);
////        leveltmp->addChild(name111);
//        leveltmp->addChild(name111, 20);
//        
//        CCLabelTTF * name1111=CCLabelTTF::create("", "hycc.ttf", 22);
//        name1111->setDimensions(CCSizeMake(200, 0));
//        name1111->setHorizontalAlignment(kCCTextAlignmentCenter);
//        name1111->setVerticalAlignment(kCCVerticalTextAlignmentTop);
//        name1111->setPosition(ccp(tmpsz.width/2, 35));
//        
//        name1111->setColor(colorbg);
////        leveltmp->addChild(name1111);
//        leveltmp->addChild(name1111, 30);
//        
//        CCLabelTTF * name11111=CCLabelTTF::create("", "hycc.ttf", 22);
//        name11111->setDimensions(CCSizeMake(200, 0));
//        name11111->setHorizontalAlignment(kCCTextAlignmentCenter);
//        name11111->setVerticalAlignment(kCCVerticalTextAlignmentTop);
//        name11111->setPosition(ccp(tmpsz.width/2, 35));
//        
//        name11111->setColor(colorbg);
////        leveltmp->addChild(name11111);
//        leveltmp->addChild(name11111, 40);
//        
//        
//        CCLabelTTF * name1=CCLabelTTF::create("", "hycc.ttf", 22);
//        name1->setDimensions(CCSizeMake(200, 0));
//        name1->setHorizontalAlignment(kCCTextAlignmentCenter);
//        name1->setVerticalAlignment(kCCVerticalTextAlignmentTop);
//        name1->setPosition(ccp(tmpsz.width/2, 35));
//        
//        name1->setColor(colorbg);
////        leveltmp->addChild(name1);
//        leveltmp->addChild(name1, 50);
        
       // name1->setTag(1001);
        name11->setTag(1002);
       // name111->setTag(1003);
       // name1111->setTag(1004);
       // name11111->setTag(1005);
